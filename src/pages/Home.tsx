      ...
      >
        ...
        <div className='relative z-10 text-center px-4 max-w-3xl'>
          ...
          <p className='mt-4 text-lg md:text-xl text-gray-200'>
            Xylem Fintech is South Africa's first licensed digital exchange for tokenised real-world assets, making premium property investment accessible to all from just R2,000.
          </p>
